...
export const cardHeight = altura_tela < 700 ? normalize(130) : normalize(160);
export const cardWidth = altura_tela < 700 ? normalize(130) : normalize(160);
export const cardMargin = altura_tela > 600 ? normalize(20) : normalize(15);
export const fontHome = altura_tela > 600 ? normalize(16) : normalize(16);
